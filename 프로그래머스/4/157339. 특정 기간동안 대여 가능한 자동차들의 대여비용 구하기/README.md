...
### 문제 풀 때 주의할 점
- 날짜 조건에서 계속 틀렸었음 모든 케이스를 잘 고려해야 함!
- START or END가 11월 안에 있는 것만 고려했기 때문
- '2022-09-30' ~ '2022-12-04'와 같은 케이스를 고려하지 못함
- 처음에 WHERE과 LEFT JOIN만 이용해서 작성 -> 틀려서 NOT IN을 사용해서 조금 더 길게 작성 (원인 파악 X) -> 다시 간단하게 작성해 볼 필요! & WITH 학습하기
---
### 성능 요약
